...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        ...
        await asyncio.sleep(2) # 😢 https://github.com/8779ANURAG/Anurag-Extra-Features/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔥 SΞΛᏒCH HΞᏒΞ 🔥', url="https://t.me/Autofiltermoviess_bot", callback_data='@Autofiltermoviess_bot')
            ],[
    ...
    if AUTH_CHANNEL and not await is_subscribed(client, message):
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🔥 JOIИ CHΛИИΞL 🔥", url='https://t.me/MOVIES_ZILAA'
                )
            ]
        ]
        ...
        await client.send_message(
            ...
            text="**ᴊᴏɪɴ ᴛʜᴇ ᴜᴘᴅᴀᴛᴇs ᴄʜᴀɴɴᴇʟ ᴀɴᴅ sᴜʙsᴄʀɪʙᴇ ʏᴏᴜᴛᴜʙᴇ ᴄʜᴀɴɴᴇʟ ᴛʜᴇɴ ɢᴏ ʙᴀᴄᴋ ᴀɴᴅ ᴄʟɪᴄᴋ ᴛʜᴇ ʟɪɴᴋ ᴀɢᴀɪɴ ғᴏʀ ғɪʟᴇs.!**",
